...
<div class="container">
    ...
    <div class="form-card">
        ...
        <form method="post" action="task?action=add" id="taskForm">
            <!-- Основная информация -->
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="status" name="status" required>
                        ...
                        <option value="On Hold">В работе</option>
                    </select>
                </div>
                        ...
                        <select id="responsibleId" name="responsibleId" required>
                            ...
                            <c:forEach var="employee" items="${employees}">
                                <option value="${employee.id}"
                                        <c:if test="${employee.id == currentEmployee.id}">selected</c:if>>
            ...
            <div class="form-group">
                ...
                <!-- В разделе объектов недвижимости измените ссылку -->
                <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Предупреждение при выборе уже используемых сущностей
    const uniqueFields = ['meetingId', 'dealId', 'conditionId'];
    uniqueFields.forEach(fieldId => {
        const field = document.getElementById(fieldId);
        if (field) {
            field.addEventListener('change', function() {
                if (this.value) {
                    console.log('Выбрана сущность ' + fieldId + ': ' + this.value + ' - помните, она должна быть уникальной');
                }
            });
        }
    });
